...
<%
	...
	try {      
        ...
        String sql = "select * from cart, user where cart.userIdx = user.userIdx and user.userId = '"+state+"' AND cart.breadID = '"+breadID+"'";
        ...
        if(found){
        	...
        	response.sendRedirect("cart_insert.jsp?_breadID="+breadID+"&_surrang="+surrang+"");
        }
