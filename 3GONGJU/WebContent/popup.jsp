...
<div class="layerPopup" id="layer_popup" style="visibility: visible;">
    <div class="layerBox">
        <h4 class="title">3GongJu 크리스마스 이벤트</h4>
        <div class="cont">
            <p>
	<a href = "Eventlist.jsp"><img src="images/pop1.jpg" width=350 height=290 usemap="#popup" alt="event page"></a>
	<a href = "Eventlist.jsp"><img src="images/pop2.jpg" width=350 height=290 usemap="#popup" alt="event page"></a>
            </p>
        </div>
          <form name="pop_form">
